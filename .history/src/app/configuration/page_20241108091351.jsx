...
const page = () => {
    ...
    Build Error
    Next.js (15.0.2) out of date (learn more)
    Failed to compile
    
    ./src/app/configuration/page.jsx
    Error:   × 'import', and 'export' cannot be used outside of module code
        ╭─[/home/windvenx/my-next-app/src/app/configuration/page.jsx:97:1]
     94 │     );
     95 │ };
     96 │ 
    ...
    ./src/app/configuration/page.jsx
    ./src/app/page.jsx
    This error occurred during the build process and can only be dismissed by fixing the error.Build Error
    Next.js (15.0.2) out of date (learn more)
    Failed to compile
