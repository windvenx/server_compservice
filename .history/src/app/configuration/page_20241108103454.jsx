...
const Page = () => {
  ...
  // Функция для изменения выбранной опции
    ...
    <>
      ...
      {selectedProcessor === 'Intel Xeon Scalable' && (
        <div>
          ...
          <ul>
            <li>Подраздел 1: X модель</li>
            <li>Подраздел 2: Y модель</li>
            <li>Подраздел 3: Z модель</li>
          </ul>
        </div>
      )}
      ...
      {selectedProcessor === 'Intel Xeon E-2200' && (
        <div>
          ...
          <ul>
            <li>Подраздел 1: A модель</li>
            <li>Подраздел 2: B модель</li>
            <li>Подраздел 3: C модель</li>
          </ul>
        </div>
      )}
            </div>
