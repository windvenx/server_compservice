...
const PowerAcc = () => {
    // Устанавливаем default значение для radio кнопки на 'option1' (без горячей замены)
    ...
    // Обработчик изменения выбора радио
    const handlePlatformChange = (event) => {
        setSelected(event.target.value);
    };

    // Обработчик изменения выбранного процессора
        ...
        <>
            <div className={styles.configutator_block}>
                ...
                <div className={styles.power__select}>
                    <div className={styles.radio__list}>
                        <div className={styles.radio}>
                            <input
                                ...
                                name="platform"
                                value="option1"
                                checked={selected === 'option1'} // checked будет равен true, если selected === 'option1'
                        ...
                        <div className={styles.radio}>
                            <input
                                ...
                                name="platform"
                                value="option2"
                                checked={selected === 'option2'} // checked будет равен true, если selected === 'option2'
                                onChange={handlePlatformChange}
                            />
                    ...
                    {/* Отображаем select в зависимости от выбранной платформы */}
                    {selected === 'option1' && (
                        <select 
