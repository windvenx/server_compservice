...
const Page = () => {
  ...
  <ul class={styles.list}>
    <li className={styles.li}>
      <label for={styles.item1}>
        Item 1
        <span></span>
      </label>
    </li >
    <li className={styles.li}>
      <label for={styles.item2}>Item 2</label>
    </li>
    <li className={styles.li}>
      <label for={styles.item3}>Item 3</label>
    </li>
    <li className={styles.li}>
      <label for={styles.item4}>Item 4</label>
    </li>
    <li className={styles.li}>
      <label for={styles.item5}>Item 5</label>
    </li>
  </ul>
</details>
