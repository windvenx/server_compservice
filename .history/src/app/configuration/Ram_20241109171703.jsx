            ...
            <div className={styles.configutator_block__right}>
                <div className="configutator_block__right__top">
                    ...
                    <select className={styles.select} name="processor" id="proc"  >
                        <option value="Выберите процессор">1 ГБ</option>
                        <option value="Intel Xeon Scalable">2 ГБ</option>
                        <option value="Intel Xeon E-2200">3 ГБ</option>
                        <option value="Выберите процессор">4 ГБ</option>
                        <option value="Intel Xeon Scalable">8 ГБ</option>
                        <option value="Intel Xeon E-2200">16 ГБ</option>
