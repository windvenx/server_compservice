            ...
            <div className={styles.configutator_block}>
                ...
                <div className={styles.power__select}>
                    ...
                    {selected === 'option2' && (
                        ...
                        >
                            <option value="">Выбетите блок питания...</option>
                            <option value="600W">900W</option>
                            <option value="700W">1000W</option>
                            <option value="800W">1200W</option>
                            <option value="900W">1400W</option>
                            <option value="1000W">1600W</option>
                            <option value="1200W">2000W</option>
                        </select>
                    )}
