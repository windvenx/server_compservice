                    ...
                    <div className='container'>
                        <div className={styles.header__wrapper}>
                            <ul className={styles.header__ul}>
                                ...
                                <Link href={'/Delivery'} className='LinkAll'>
                                    <li>Доставка</li>
                                </Link>
                                <Link href={'/support'} className='LinkAll'>
                                    <li>Поддержка</li>
                                </Link>
                                <Link href={'/Leasing'} className='LinkAll'>
                                    <li>Калькулятор RAID</li>
                                </Link>
                                <li>Блог</li>
                                <Link href={'/AboutUs'} className='LinkAll'>
                                    <li>О нас</li>
                                </Link>
                                <Link href={'/ContactUs'} className='LinkAll'>
                                    <li>Контакты</li>
                                </Link>
